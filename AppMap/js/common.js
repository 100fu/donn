...
var BDZFunction = {
    ...
    checkNum: function () {
        ...
        if (flg == true)
        { event.returnValue = false; } else if (event.keyCode == 8 || event.keyCode == 46) {
    ...
    paginationFind: function (pageselectCallback) {
        clientMode.post(pagingFindMode.pathurl, pagingFindMode, function (data) {
            if (data != null) {
                if (data > 0) {
                    totalRows = data;
